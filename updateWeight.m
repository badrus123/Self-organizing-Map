function WeightVectorUpdated = updateWeight(  data, somMap, somRow, ... 
...
% distance between winning neuron and other neuron
    ...
    for r = 1: somRow
       for c = 1:somCol
           ...
           WeightVectorUpdated(r,c,:) = currentWeightVector + learningRate*neighborhood(r,c)*(data(index,:)-currentWeightVector);
